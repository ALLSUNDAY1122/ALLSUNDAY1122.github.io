...
const targets = [
  ...
  { name: 'five-minute', url: `${base}/5min-horror.html`, required: ['5分で読める怖い話', 'class="pick"', 'class="guide-card"', 'assets/landing-share.js?v=20260724-002', 'data-runtime="landing-start-20260724-001"', 'YORUGATARI_LANDING_START', '/yorugatari/__landing-start/five-minute', '特集単位の合計だけを匿名で集計します', 'assets/analytics.js?v=20260724-004'], forbidden: ['assets/engagement.js'] },
  { name: 'bedtime', url: `${base}/bedtime-horror.html`, required: ['寝る前に読む怖い話', '"numberOfItems":8', 'class="pick"', 'class="mood-card"', '"@type":"FAQPage"', 'assets/landing-share.js?v=20260724-002', 'data-runtime="landing-start-20260724-001"', 'YORUGATARI_LANDING_START', '/yorugatari/__landing-start/bedtime', '特集単位の合計だけを匿名で集計します', 'assets/analytics.js?v=20260724-005'], forbidden: ['assets/engagement.js'] },
  ...
  try {
    ...
    const response = await fetch(`${target.url}${separator}verify=${Date.now()}-${attempt}`, {
      ...
      headers: {
        ...
        pragma: 'no-cache',
        'user-agent': 'Yorugatari-Live-Check/2.3'
      }
    });
