Pod::Spec.new do |spec|
  spec.name = 'ToruTangoOcr'
  spec.version = '1.0.0'
  spec.summary = 'Apple Vision OCR for Toru Tango'
  spec.description = 'Local Expo module that recognizes Japanese study material with Apple Vision.'
