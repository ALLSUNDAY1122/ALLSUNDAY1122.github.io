...
enum KanriAppConfig {
    ...
    static let subjects = [
        "社会・環境", "人体・疾病", "食べ物", "基礎栄養", "応用栄養",
        "栄養教育", "臨床栄養", "公衆栄養", "給食経営", "応用力"
    ]
    static let expectedPerRound: [String: Int] = [
        "社会・環境": 16, "人体・疾病": 26, "食べ物": 25, "基礎栄養": 14,
        "応用栄養": 16, "栄養教育": 13, "臨床栄養": 26, "公衆栄養": 16,
        "給食経営": 18, "応用力": 30
    ]
    static let qualificationConfig = QualificationConfig(
    ...
    static var uiTestPremium: Bool {
        ProcessInfo.processInfo.arguments.contains("-UITestPremium")
    }
}
