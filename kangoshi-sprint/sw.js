const CACHE='kangoshi-sprint-v21-20260809-audit1';
const ASSETS=['./','./index.html','./style.css','./questions.js','./questions-numeric.js','./questions-audit-v1.js','./app-v03.js','./manifest.json'];
