...
struct MeshARPlacementView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> ARSCNView {
        ...
        view.automaticallyUpdatesLighting = true; view.autoenablesDefaultLighting = true; view.antialiasingMode = .multisampling2X; view.temporalAntialiasingEnabled = true; view.scene = SCNScene(); context.coordinator.attach(to: view)
