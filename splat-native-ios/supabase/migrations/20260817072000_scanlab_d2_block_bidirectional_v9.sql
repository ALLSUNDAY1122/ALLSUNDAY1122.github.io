...
-- Preserve the closed scan-table visibility boundary: public delivery continues through scanlab-public.
...
-- Existing RLS policies call these helpers. Do not create a direct public SELECT
-- policy on scanlab_scans here; D2 visibility hardening intentionally keeps the
-- base table closed to public delivery.
