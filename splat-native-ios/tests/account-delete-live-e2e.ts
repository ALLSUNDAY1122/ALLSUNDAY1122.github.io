...
try {
  ...
  // D2-004/D2-015 intentionally reject arbitrary client uploads. Seed a historical
  // orphan with service-role authority so account deletion still proves it removes
  // owner-prefix residue that predates the trusted package policy.
