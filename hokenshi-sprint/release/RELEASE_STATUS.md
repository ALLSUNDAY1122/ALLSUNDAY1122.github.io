...
## 到達状態
**標準手順 v2.5再適用済み / Apple操作直前までのNative Release Gate PASS / Apple新規Appレコード作成待ち**

## v2.5再確認・差分適用
2026-08-14時点の現行標準手順 v2.5を再確認し、本アプリへ次を適用済み。
- 学びスプリント課金標準: 本アプリは完成教材として長期利用できるため、既採用の非消耗型・買い切りPremiumを維持し、日本向け価格を`800円`へ確定（価格標準はv2.4で導入、v2.5でも継続）
...
## 課金方式
- 非消耗型・買い切りPremium
- 日本向け価格: `800円`（現行標準手順 v2.5。価格標準はv2.4で導入）
