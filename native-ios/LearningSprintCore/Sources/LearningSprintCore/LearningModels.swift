...
public enum LearningAnswerType: String, Codable, Sendable {
    case singleChoice
    case multiChoice
    case numeric
    case blankSelect
...
public struct BlankField: Codable, Hashable, Sendable {
    ...
    public init(key: String, label: String, options: [String], correctValue: String) {
        self.key = key
        self.label = label
...
public struct LearningQuestion: Codable, Identifiable, Hashable, Sendable {
    ...
    public init(
        ...
        premium: Bool = false,
        examRound: String? = nil,
        questionNumber: String? = nil,
        rightsBasis: String? = nil
    ) {
        self.id = id
...
public struct AnswerPayload: Codable, Equatable, Sendable {
    ...
    public var blankValues: [String: String]
    public var declarationValues: [String: String]
    public var isUnknown: Bool

    public init(
        selectedIndices: [Int] = [],
        numberValue: Double? = nil,
        blankValues: [String: String] = [:],
        declarationValues: [String: String] = [:],
        isUnknown: Bool = false
    ) {
        self.selectedIndices = selectedIndices
        self.numberValue = numberValue
        self.blankValues = blankValues
        self.declarationValues = declarationValues
...
public struct AnswerEvaluation: Codable, Equatable, Sendable {
    ...
    public init(isCorrect: Bool, isUnknown: Bool, message: String) {
...
public struct WeakQuestionState: Codable, Equatable, Sendable {
    ...
    public init(consecutiveCorrect: Int = 0, lastAnsweredAt: Date = Date()) {
...
public struct LearningState: Codable, Equatable, Sendable {
    ...
    public init(
        ...
        weakQuestions: [String: WeakQuestionState] = [:],
...
public struct QualificationConfig: Codable, Equatable, Sendable {
    public let qualificationName: String
    ...
    public let defaultExamDate: Date?
    ...
    public init(
        ...
        codemagicProfile: String,
        productID: String?,
        version: String = "1.0.0",
        teamID: String = "MN3D2ZM44N",
        subjects: [String],
        defaultExamDate: Date? = nil
    ) {
        ...
        self.defaultExamDate = defaultExamDate
    }
}
