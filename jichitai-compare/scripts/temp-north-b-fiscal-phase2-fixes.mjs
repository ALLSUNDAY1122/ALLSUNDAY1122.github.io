...
const now = '2026-07-25T13:15:00+09:00';
...
function municipalityPath(code) {
  return path.join(root, 'data', 'municipalities', code.slice(0, 2), `${code}.json`);
}
...
function updateTask(code, note) {
  ...
  task.officialSources = [...new Set(Object.values(data.services || {})
...
updateMunicipality('04401', (data) => {
  ...
  service.source = {
    url: 'https://www.town.miyagi-matsushima.lg.jp/index.cfm/6%2C36300%2C17%2C124%2Chtml',
    checkedAt: today
  };
  service.additionalSources = [{
    url: 'https://www.town.miyagi-matsushima.lg.jp/page/1360.html',
    checkedAt: today
  }];
});
...
updateMunicipality('05212', (data) => {
  ...
  service.source = {
    url: 'https://www.city.daisen.lg.jp/reiki/reiki_honbun/r154RG00000819.html',
    checkedAt: today
  };
...
updateMunicipality('05213', (data) => {
  const service = data.services.schoolMeals;
  service.source = {
    url: 'https://www1.g-reiki.net/city.kitaakita/reiki_honbun/r406RG00000646.html',
    checkedAt: today
  };
  service.additionalSources = [];
...
updateMunicipality('06382', (data) => {
  ...
  const normalCare = 'https://town.kawanishi.yamagata.jp/kenko/kosodateshien/2024-0906-1025-68.html';
  ...
  service.source = { url: normalCare, checkedAt: today };
...
triage.manualReview.remaining = {
  fiscalLowPriority: 16,
...
checkpoint.workingBranch = 'audit/north-b-fiscal-anyone-triage-20260725';
checkpoint.pullRequestNumber = 3330;
checkpoint.ciStatus = 'pending';
checkpoint.nextAction = 'PR #3330の最終CIとmain統合後、確定修正8自治体・監査記録・checkpointをregion/northへ限定同期する。続いて旧年度低優先16件と誰でも通園優先度50未満74件を確認する。';
checkpoint.fiscalAnyoneAudit = {
  ...(checkpoint.fiscalAnyoneAudit || {}),
  phase2FiscalReviewed: 14,
  phase2CorrectionMunicipalities: ['04401','04422','05212','05213','06382'],
