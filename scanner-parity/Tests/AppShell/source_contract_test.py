...
checks = {
    ...
    "completed session restore": ".restoreCompleted" in store and "isCompletedPackageCheckpoint" in store,
    "corrupt checkpoint rejected before UI restore": "checkpoint.hasCanonicalExistingArtifacts" in store,
