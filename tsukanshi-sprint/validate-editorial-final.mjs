...
for(let n=61;n<=240;n++){const id=`V03-S-${String(n).padStart(3,'0')}`,q=Q.find(x=>x.id===id);if(!q)fail(id,'missing');else{if(q.choices?.length!==4)fail(id,'must have 4 choices');if(q.editorialMethod!=='curated-cross-topic-distractors')fail(id,'curated distractor method missing');}}
