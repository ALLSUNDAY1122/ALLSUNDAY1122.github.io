...
def main():
    ...
    result={'ok':True,'request_id':cmd.get('request_id'),'action':'build_yoru','app_id':APP_ID,'workflow_id':WORKFLOW_ID,'branch':BRANCH,'build_id':build_id,'version':'1.2.0','build_number':'4','review_submission':False}
